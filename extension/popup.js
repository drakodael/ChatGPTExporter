...
function buildExportReport(imageResult, attachmentResult, hadToken, attachmentResolverDiagnostics, imageResolverDiagnostics, imageDiscoveryDiagnostics, unresolvedImageAttachmentDiagnostics) {
  ...
  return [
    ...
    `image-auth-context-account-id-present: ${imageResolver.account_id_present || 0}`,
    `image-auth-context-gizmo-id-present: ${imageResolver.gizmo_id_present || 0}`,
    `image-auth-context-gizmo-is-project: ${imageResolver.gizmo_is_project || 0}`,
    `image-resolver-account_context-attempts: ${imageResolver.account_context_attempts || 0}`,
    `image-resolver-account_context-resolved: ${imageResolver.account_context_resolved || 0}`,
    `image-resolver-account_context-http_403: ${imageResolver.account_context_http_403 || 0}`,
    `image-resolver-project_context-attempts: ${imageResolver.project_context_attempts || 0}`,
    `image-resolver-project_context-resolved: ${imageResolver.project_context_resolved || 0}`,
    `image-resolver-project_context-http_403: ${imageResolver.project_context_http_403 || 0}`,
    ...
    ...[1, 2].flatMap((endpointNumber) => [
      ...
      `image-resolver-endpoint_${endpointNumber}-account_context-attempts: ${imageResolver[`endpoint_${endpointNumber}_account_context_attempts`] || 0}`,
      `image-resolver-endpoint_${endpointNumber}-account_context-resolved: ${imageResolver[`endpoint_${endpointNumber}_account_context_resolved`] || 0}`,
      `image-resolver-endpoint_${endpointNumber}-account_context-http_403: ${imageResolver[`endpoint_${endpointNumber}_account_context_http_403`] || 0}`,
      `image-resolver-endpoint_${endpointNumber}-project_context-attempts: ${imageResolver[`endpoint_${endpointNumber}_project_context_attempts`] || 0}`,
      `image-resolver-endpoint_${endpointNumber}-project_context-resolved: ${imageResolver[`endpoint_${endpointNumber}_project_context_resolved`] || 0}`,
